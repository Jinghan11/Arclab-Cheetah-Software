...
#ifndef __LCM_N100IMU_lcm_hpp__
#define __LCM_N100IMU_lcm_hpp__
...
int N100IMU_lcm::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int N100IMU_lcm::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int N100IMU_lcm::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t N100IMU_lcm::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* N100IMU_lcm::getTypeName()
{
    return "N100IMU_lcm";
}

int N100IMU_lcm::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int N100IMU_lcm::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int N100IMU_lcm::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t N100IMU_lcm::_computeHash(const __lcm_hash_ptr *)
{
